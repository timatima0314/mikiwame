  ...
  referee: {
    jp: {
      message: {
        ...
        hideLicenseNumberAndAddress:'免許証・会社名、学校名が記載された社員証など。※免許証の番号や住所、生年月日は付箋などで隠して頂いて構いません。',
        submitProofOfIdentity:'または、名刺：同じ名刺を複数枚 その他、ご自身であることが証明できる顔写真やお名前が記載されている内容でございましたらご提出は可能です。',
        pleaseHelpPreventIdentityTheft:'なりすまし防止にご協力ください。',
    ...
    en: {
      ...
      message: {
        ...
        hideLicenseNumberAndAddress:"Driver's license, company ID with the name of the company or school, etc.※You may hide the license number, address, and date of birth with a sticky note or other means.",
        submitProofOfIdentity:'Or, business cards: multiple copies of the same business card.You may submit any other information that can prove your identity, such as a photo and your name.',
        pleaseHelpPreventIdentityTheft:'Please help us prevent identity theft.',
    ...
    cn: {
      ...
      message: {
        ...
        hideLicenseNumberAndAddress:'驾照、公司名称、带有学校名称的员工身份证等※您可以使用便签隐藏您的驾照号码、地址和出生日期。',
        submitProofOfIdentity:'或者，名片：同一张名片的多份副本，如果内容中包含可以证明你身份的人脸照片或姓名，你可以提交。',
        pleaseHelpPreventIdentityTheft:'请帮助我们防止冒充。',
        uploadPicture: '相片上傳',
        notSelected: '尚未選擇',
