  ...
  referee: {
    jp: {
      message: {
        ...
        pleaseUploadProofImage:'本人様確認の為、証明画像のアップロードをお願い申し上げます。',
        referenceCheckComplete:'アップロード後、リファレンスチェック評価が完了となります。',
        pleaseHelpPreventIdentityTheft:'推薦者様には、お手数をお掛け致しますが「なりすまし回答防止」にご協力ください。',
        presentingExamples:'ご提出例',
        license:'・免許証',
        hideLicenseNumberAndAddress:'※免許証の番号、住所、生年月日などは、付箋等で隠しても構いません。',
        employeeIdCard:'・社員証',
        employeeOrStudentIdCard:'※会社名、学校名などが記載されている社員証、学生証など。',
        businessCard:'・名刺',
        photographMultipleBusinessCardsAppear:'※１枚ではなく、同じ名刺が複数枚画像に写るよう撮影をお願いいたします。',
        other:'・その他',
        submitYourPhoto:'※ご自身であることが証明できる顔写真、お名前が記載されている内容であればご提出は可能です。',
        uploadPicture: '写真アップロード',
        notSelected: '選択されていません',
        registerAndContinue: '回答を完了する',
        completelyDeletedAfterCertainPeriod:' アップロード頂きました画像につきまして、法令を遵守し一定期間を過ぎますと完全に削除されますので、ご安心ください。',
    ...
    en: {
      ...
      message: {
        ...
        pleaseUploadProofImage:'Please upload an image to verify your identity.',
        referenceCheckComplete:'After uploading, the reference check evaluation is complete.',
        pleaseHelpPreventIdentityTheft:'We appreciate your cooperation in preventing spoofed responses.',
        presentingExamples:'Presentation Method',
        license:'・License',
        hideLicenseNumberAndAddress:"※License number, address, date of birth, etc. may be hidden by sticky notes or other means.",
        employeeIdCard:'・ID card',
        employeeOrStudentIdCard:'※Employee or student ID card with company or school name, etc.',
        businessCard:'・business card',
        photographMultipleBusinessCardsAppear:'※Please take multiple pictures of the same business card in the image, not just one.',
        other:'・Other',
        submitYourPhoto:'※You may submit the information as long as it includes a photo that proves you are the applicant and your name.',
        uploadPicture: 'Photo Upload',
        notSelected: 'Not selected',
        registerAndContinue: 'Register and Next',
        completelyDeletedAfterCertainPeriod:' Please be assured that all uploaded images will be completely deleted after a certain period of time in compliance with the law.',
        ...
        toIncreaseSecurity: 'To increase security through two-step authentication',
        connectYourPhoneNumberToYourAccount: 'Connect your phone number to your account: {account}',
    ...
    cn: {
      ...
      message: {
        ...
        pleaseUploadProofImage:'请上传证明图片以验证您的身份。',
        referenceCheckComplete:'上传后，参考检查评估完成。',
        pleaseHelpPreventIdentityTheft:'对于给您带来的不便，我们深表歉意，但请配合“防止欺骗答案”。',
        presentingExamples:'提交示例',
        license:'・驾驶执照',
        hideLicenseNumberAndAddress:'※您可以使用便签隐藏您的驾照号码、地址、出生日期等。',
        employeeIdCard:'・员工身份证',
        employeeOrStudentIdCard:'※带有公司名称、学校名称等的员工证、学生证等。',
        businessCard:'・名片',
        photographMultipleBusinessCardsAppear:'※请为同一张名片拍摄多张照片，而不是一张。',
        other:'・其他',
        submitYourPhoto:'※只要包含可证明您的身份和姓名的面部照片，您就可以提交。',
        uploadPicture: '相片上傳',
        notSelected: '尚未選擇',
        registerAndContinue: '註冊並下一頁',
        completelyDeletedAfterCertainPeriod:' 请放心，上传的图片将在一定时间后依法完全删除。',
        ...
        toIncreaseSecurity: '通过2步认证提高安全性',
        connectYourPhoneNumberToYourAccount: '将你的电话号码连接到你的账户: {account}',
        pleaseRegisteringPhoneNumber: '请注册您的电话号码。',
        canReceiveSMS: '请输入可以接收短信的手机号码。',
        placeholderPhoneNumber: '请输入你的手机号码',
        sendCode: '发送验证码',
