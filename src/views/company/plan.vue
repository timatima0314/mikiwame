  ...
  <el-card v-loading="loading" class="container">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="non">
            ...
            >
              <b v-if="planStatus === PLAN_STATUSES.LIGHT"
                >このプランを申し込む</b
              >
              <b v-else-if="planStatus === PLAN_STATUSES.ORDERING_STANDARD"
                >申請中</b
              >
              <b v-else-if="planStatus === PLAN_STATUSES.STANDARD"
                >現在のプラン</b
              >
            </el-button>
          </td>
    ...
    <div class="price">
      ...
      <p>
        ...
        <span style="margin-left: 1em; white-space: pre">見出し</span
        ><span style="margin-left: 1em">記事5円（全国紙）10円（地方紙）</span
        ><br />
        <span style="margin-left: 1em">本文閲覧料</span
        ><span style="margin-left: 1em"
          >1記事100円（全国紙）150円（地方紙）課金</span
        ><br />
        ・WEB<span style="margin-left: 1em">1検索料：450円</span><br />
        <span style="margin-left: 1em">見出し、閲覧料は一切かかりません。</span
        ><br />
      </p>
    </div>
    <div class="price">
